...
public class PersonalDocument {
    ...
    private PersonalDocument() {
        documentTypes.put("LE", new DocumentType(
                "LIBRETA ELECTORAL",
                8,
                8
        ));
        documentTypes.put("DNI", new DocumentType(
                "DOCUMENTO NACIONAL DE IDENTIDAD",
                8,
                8
        ));
        documentTypes.put("CE", new DocumentType(
                "CARNET DE EXTRANJERIA",
                9,
                9
        ));
        documentTypes.put("CR", new DocumentType(
                "CARNET DE REFUGIADO",
                12,
                12
        ));
        documentTypes.put("CI", new DocumentType(
                "CARNET DE IDENTIDAD",
                12,
                12
        ));
        documentTypes.put("PASAPORTE", new DocumentType(
                "PASAPORTE",
                12,
                12
        ));
